...
if __name__ == "__main__":
  #self defined flags.
  flags.DEFINE_bool("change_file",False,"whether change the input data file")
  flags.DEFINE_bool("is_training",True,"in training phase, with dropout")
  flags.DEFINE_integer("eval_loop",100,"the loop size of eval")
  flags.DEFINE_float("keep_prob",0.5,"keep_prob for dropout")
  
  # Dataset flags.
  flags.DEFINE_string("train_dir", "/tmp/yt8m_model/",
                      "The directory to save the model files in.")
  flags.DEFINE_string("checkpoint_name","","iter of checkpoint")
  flags.DEFINE_string(
      "train_data_pattern", "",
  ...
  flags.DEFINE_integer("time_to_save_model",2*60,"minutes to save model")

  flags.DEFINE_integer("max_to_save",20,"max numbers of models to save")
